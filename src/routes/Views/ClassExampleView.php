<script type="module" src="/src/routes/Views/ClassExampleView.js?v=<?= APP_VERSION ?>" defer></script>
<style> @import url('/src/routes/Views/ClassExampleView.css?v=<?= APP_VERSION ?>'); </style>
